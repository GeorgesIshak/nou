...
"/images/projects/the-marigate1.jpg",
      ...
      "/images/projects/the-marigate5.jpg",
      "/images/projects/the-marigate6.jpg",
      "/images/projects/the-marigate7.jpg",
      "/images/projects/the-marigate8.png",
...
By shifting and aligning with the grid, the balconies carve out voids within the façade, set against the sleek glass walls of the interiors. This interplay generates a dynamic, diagonal rhythm across the building. The fair-faced concrete balcony walls not only frame the outdoor spaces but also enhance the sense of depth, giving the structure a bold yet refined presence.`,
 ...
 "/images/projects/the-square1.jpg",
      ...
      "/images/projects/the-square5.jpg",
      "/images/projects/the-square6.jpg",

    ],
  },
  {
    slug: "springside-residence",
    title: "Springside Residence",
    type: "Residential Building",
    size: "680sqm",
    location: "Limassol, Cyprus",
    status: "Completed",
    description: `Nestled in a vibrant neighborhood of Limassol, Springside Residence is a compact residential building designed around the concept of green living in the city. At its core lies an open vertical courtyard—a verdant spine that brings light, ventilation, and nature into the heart of the building, extending from the ground-level garden up through every floor.
Flanked by contrasting landscapes—a tranquil public park on one side and a riverbank adjacent to a busy highway on the other—the residence offers a dynamic living experience that connects urban life with natural serenity.
The façade comes alive with a rhythmic play of shifting balconies, each one uniquely positioned to enhance views and privacy. These outdoor extensions are more than functional; they reinterpret the landscape by integrating lush flower beds and sculptural planters, each featuring a tree dedicated to its respective apartment. The result is a vertical garden that softens the building's form while reinforcing its strong connection to the natural surroundings.`,
   "mainImage": "/images/projects/springside1.jpg",
    "images": [
      ...
      "/images/projects/springside5.jpg",
      "/images/projects/springside6.jpg",
      "/images/projects/springside7.jpg",
      "/images/projects/springside8.jpg",
      "/images/projects/springside9.jpg",
      "/images/projects/springside10.jpg",
      "/images/projects/springside11.jpg"
    ]
  },
  {
    slug: "te-house",
...
Spread across two levels, the ground floor hosts the living areas, where the interior merges with a central garden, two courtyards, and a pool that extends the living space outdoors. The clients’ vision of a house immersed in nature comes alive here, with greenery framing daily life. Framed by the lush garden, the boundaries between inside and outside are blurred, creating a home that flows effortlessly with nature. On the upper floor, bedrooms are flooded with natural light and oriented toward tranquil views of the gardens and courtyards. The result is a serene retreat at the heart of the city, where history, nature, and modern living coexist in harmony.`,
  ...
  },
  {
    ...
    location: "Sia, Cyprus",
    status: "Completed",
    description: `Nestled on a hilltop and fully off-grid, this residence is designed to merge seamlessly with its natural surroundings. Its façade, finished in a warm brown pigment, allows the house to blend effortlessly into the landscape.
The main elevation rises to 4.3 meters, framing sweeping views of the surrounding olive fields. Inside, the open-plan living, dining, and kitchen areas are immersed in light and nature, evoking a sense of awe and connection with the outdoors.
The house is composed of two volumes: the taller 4.3-meter-high living space gradually slopes down to the more intimate 3-meter-high sleeping quarters. At their intersection, a continuous band of windows introduces soft, indirect light and ensures natural cross-ventilation, reinforcing the home’s harmony with its environment.
The interior material selection of the house is also of nature by using real travertino marble for the living space, terrazzo bathrooms, and parquet floors.`,
 "mainImage": "/images/projects/sia-house1.jpg",
    "images": [
      ...
      "/images/projects/sia-house5.jpg",
      "/images/projects/sia-house6.jpg",
      "/images/projects/sia-house7.jpg",
      "/images/projects/sia-house8.jpg",
      "/images/projects/sia-house9.jpg",
      "/images/projects/sia-house10.jpg",
      "/images/projects/sia-house11.jpg"
    ]
  },
  {
    slug: "the-tetris",
...
Responding to the sun’s path, the tower subtly twists as it rises, creating a dynamic silhouette. This movement, along with the extrusion of units, generates spacious balconies and terraces for every apartment—each one opening to panoramic views of the sea and the port.`,
    ...
    images: [
      ...
      "/images/projects/tetris5.jpg",
      "/images/projects/tetris6.jpg",
    ],
  },
  {
    slug: "pearl-house-5",
    ...
    location: "Limassol, Cyprus",
    status: "Completed",
    description: `The program was simple: four floors, each with two two-bedroom apartments. With the plot surrounded by three roads, the main design challenge was to maximize views and orientation for each unit, while ensuring privacy and separation between neighbors.
The key feature of the project was rethinking the conventional separation walls between units and their balconies. Instead of flat dividers, Pearl House 5 introduces curved, concave separation walls and flowing balconies that define the identity of the building. These walls extend beyond the façade, forming sculptural extrusions along each floor and creating a sense of movement and rhythm across the elevation.
Located in a quiet residential area of Larnaca, Pearl House 5 distinguishes itself from its surroundings. The building has become a recognizable reference point in the neighborhood, affectionately known as “the curved building.”`,
    ...
    images: [
      ...
      "/images/projects/pearl-house5-5.jpg",
      "/images/projects/pearl-house5-6.jpg",
    ],
  },
  {
    slug: "koumi-villas",
    ...
    location: "Limassol, Cyprus",
    status: "Completed",
    description: `The triangular plot posed the challenge of accommodating three independent houses for three different families. The design response was to reinterpret the traditional pitched roof with red tiles—requested by the developer—through a modern approach to massing and spatial composition.
Windows are accentuated with bold framing elements, while the main circulation staircases are fully glazed, transforming them into both a light feature and a defining element of the façade. Vertical louvers provide privacy while allowing filtered daylight, reinforcing the balance between openness and intimacy.`,
  ...
  
  {
   ...
   "images": [
    "/images/projects/h432-1.jpg",
        ...
        "/images/projects/h432-5.jpg",
        "/images/projects/h432-6.jpg",
    ],
  },
  {
    "slug": "port-avenue",
  ...
  {
    "slug": "down-town-views",
    "title": "Down Town Views",
    "type": "Residential Building",
    "size": "1250sqm",
    "location": "Nicosia, Cyprus",
    ...
    "images": [
      ...
      "/images/projects/down-town-view5.jpeg",
      "/images/projects/down-town-view6.jpg",
      "/images/projects/down-town-view7.jpg",
      "/images/projects/down-town-view8.jpeg"]
  },
  {
    "slug": "the-gem",
    "title": "The Gem",
  ...
  },
  {
    ...
    "images": [
      ...
      "/images/projects/marina-living5.jpg",
  ...
  },
  {
    ...
    "images": [
      ...
      "/images/projects/ras-villa5.jpg",
